...
var DetailedChart = function DetailedChart(_ref) {
  var containerList = _ref.containerList,
      labelAxysY = _ref.labelAxysY,
      unitLabel = _ref.unitLabel,
      unit = _ref.unit,
      _ref$averageFormatter = _ref.averageFormatter,
      averageFormatter = _ref$averageFormatter === undefined ? function (average) {
    return parseFloat(average).toFixed(1);
  } : _ref$averageFormatter,
      _ref$unitNormalizer = _ref.unitNormalizer,
      unitNormalizer = _ref$unitNormalizer === undefined ? function (unit) {
